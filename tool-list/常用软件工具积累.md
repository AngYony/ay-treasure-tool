...
| tightvnc                                                     | 远程控制软件                                                 |
| Taskade                                                      | 效率工具                                                     |
| Roam research                                                | 支持双链笔记                                                 |
| Obsidian                                                     | 笔记软件                                                     |
| Scrintal                                                     | 卡片记录+选择困难症                                          |
| FlowUs（推荐）                                               | Notion替代工具                                               |
| SQLiteStudio                                                 | SQLite客户端工具Github开源                                   |
...
- 打开任务管理器
- 切换到“性能”选项卡，选择“打开资源监视器”。
- 在资源监视器中，切换到“CPU”选项卡
- 在“关联的句柄”中，输入被占用的文件夹名称，稍等片刻，会显示正在使用该文件夹的进程列表。
- 右击进程列表，选择”结束进程“，即可解锁该文件。

![image-20240219140513738](./assets/image-20240219140513738.png)



### 快速 cmd 到一个目录

可以先通过资源管理器打开该目录，然后在地址栏中输入“cmd”，将打开cmd窗口，并进入到该目录中。
...
![image-20251007165159042](./assets/image-20251007165159042.png)
