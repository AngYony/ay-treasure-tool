...
![image-20211125124846598](assets/image-20211125124846598.png)

此处，子网IP为：192.168.171.0，子网掩码为：255.255.255.0。这两个信息很重要，将会被配置到CentOS中。

“DHCP设置”按钮只有在复选框选中时，才可以点击编辑。一般情况下，不需要选中，如果要启用DHCP设置，也可以进行相关的配置（见下文）。
...
“DHCP设置”按钮只有在复选框选中时，才可以点击编辑。一般情况下，不需要选中。一旦启用了DHCP设置，那么在点击“DHCP设置...”按钮，查看IP地址的范围，最终CentOS设置的IP地址，必须在这个范围内。
